...
Clinic::Clinic() : arNurses_(0), arDoctors_(0), nursesInAR_(0), nbDocs_(0) {}

Clinic::Clinic(Nurse** nurses, Doctor** doctors, int nbNurses, int nbDocs) :
    arNurses_(nurses), arDoctors_(doctors), nursesInAR_(nbNurses), nbDocs_(nbDocs) {}
